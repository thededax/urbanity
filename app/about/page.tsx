    ...
    <main className="flex-grow pt-[80px] md:pt-0">
      ...
      <section className="py-section-padding px-6 md:px-gutter mx-auto max-w-container-max pt-[140px]">
        <div className="flex flex-col md:flex-row gap-8 md:gap-[120px] items-center">
          <motion.div 
            className="w-full md:w-5/12 aspect-[3/4] bg-surface-container relative"
      ...
      <section className="py-section-padding bg-surface-container relative">
        ...
        <div className="mx-auto max-w-container-max px-6 md:px-gutter">
          <motion.div 
            className="max-w-4xl mx-auto text-center flex flex-col gap-12 relative z-10"
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 1 }}
          >
            <span className="material-symbols-outlined text-primary text-6xl mx-auto icon-filled">format_quote</span>
      ...
      <section className="py-section-padding mx-auto max-w-container-max px-6 md:px-gutter">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Mission Card */}
          <motion.div 
            className="bg-surface-container p-8 md:p-12 border border-white/5 hover:shadow-[0_0_40px_rgba(201,168,76,0.05)] transition-all duration-300 flex flex-col gap-4 relative group overflow-hidden rounded-lg"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <span className="material-symbols-outlined text-primary text-4xl mb-4 font-light icon-light">track_changes</span>
          ...
          >
            <div className="absolute top-0 left-0 w-1 h-full bg-primary scale-y-0 group-hover:scale-y-100 origin-top transition-transform duration-300"></div>
            <span className="material-symbols-outlined text-primary text-4xl mb-4 font-light icon-light">visibility</span>
