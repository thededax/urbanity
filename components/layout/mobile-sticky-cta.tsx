  ...
  return (
    ...
    >
      <div className="grid grid-cols-3 h-full divide-x divide-background/20 text-background font-bold text-[11px] uppercase tracking-wider items-center justify-center text-center">
        <a href="tel:+1234567890" className="flex items-center justify-center gap-1.5 h-full w-full hover:bg-black/10 transition-colors">
          <span className="material-symbols-outlined text-[16px]">call</span>
          Call
        </a>
        <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-1.5 h-full w-full hover:bg-black/10 transition-colors">
